...
use {
    crate::hypervisor::arch::X86_64Regs, crate::mem::layout::SandboxMemoryLayout,
    crate::mem::mgr::SandboxMemoryManager, crate::mem::shared_mem::HostSharedMemory,
    fallible_iterator::FallibleIterator, framehop::Unwinder,
};
...
#[cfg(feature = "mem_profile")]
pub(crate) fn write_stack(out: &mut std::fs::File, stack: &[u64]) {
...
#[cfg(feature = "mem_profile")]
pub(crate) fn record_trace_frame<F: FnOnce(&mut std::fs::File)>(
    trace_info: &TraceInfo,
    frame_id: u64,
    write_frame: F,
) -> Result<()> {
...
pub(crate) fn record_guest_trace_frame<F: FnOnce(&mut std::fs::File)>(
    trace_info: &TraceInfo,
    frame_id: u64,
    cycles: u64,
    write_frame: F,
