...
use crate::hypervisor::handlers::{
    DbgMemAccessHandler, DbgMemAccessHandlerWrapper, DbgReadMemAccessHandlerFunction, DbgWriteMemAccessHandlerFunction, MemAccessHandler, MemAccessHandlerFunction, MemAccessHandlerWrapper
};
...
pub(crate) fn dbg_mem_access_handler_wrapper(
    ...
    let dbg_mem_access_hdl = DbgMemAccessHandler::from((read_access_func, write_access_func));
