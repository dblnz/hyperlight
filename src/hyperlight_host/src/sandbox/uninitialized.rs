...
pub struct UninitializedSandbox {
    ...
    /// Correlation identifier for this sandbox instance, generated by the host.
    /// This ID can be used to correlate logs and telemetry across layers.
...
impl UninitializedSandbox {
    ...
    /// Returns the correlation ID assigned to this sandbox.
    /// Useful for tagging logs and diagnostics that originate from this sandbox.
